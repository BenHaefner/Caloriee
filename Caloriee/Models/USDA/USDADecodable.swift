...
struct CodableFoundationFood: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case foodClass, description, foodNutrients, foodAttributes, nutrientConversionFactors,
             isHistoricalReference, ndbNumber, dataType, foodCategory
        case fdcID = "fdcId"
...
struct CodableSurveyFood: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case foodClass, description, footnote, foodNutrients, foodAttributes, foodCode, startDate,
             endDate, wweiaFoodCategory, dataType
        case fdcID = "fdcId"
...
extension CodableWweiaFoodCategory {
    ...
    func with(
        ...
        return CodableWweiaFoodCategory(
            ...
            ?? self.wweiaFoodCategoryDescription,
